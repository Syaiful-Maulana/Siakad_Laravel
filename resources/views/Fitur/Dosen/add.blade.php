                    ...
                    <div class="col-md-4 offset-md-4">
                        <form action="{{ url('dosen')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nidn" autocomplete="off" class="form-control @error('nidn') is-invalid @enderror" value="{{ old('nidn') }}" autofocus>
                                @error('nidn')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <label class="mt-3">Email</label>
                                <input type="text" name="email" autocomplete="off" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" autofocus>
                                @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
