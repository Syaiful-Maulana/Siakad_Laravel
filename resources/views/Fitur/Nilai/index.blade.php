      ...
      <div class="card">
        <div class="card-body table-responsive">
          ...
          <div class="col-lg-12 d-grid gap-2 d-md-flex justify-content-md-end">
              <a href="{{ url('nilai/create')}}" class="btn btn-success btn-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ url('nilai/'.$item->id)}}" class="btn btn-warning btn-sm">
                          <i class="fas fa-eye"></i>
                      </a>
                        <a href="{{ url('nilai/' .$item->id .'/edit')}}" class="btn btn-primary btn-sm">
