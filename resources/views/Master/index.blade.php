...
@section('search')
<form class="form-inline mr-auto" action="admin" method="GET">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ url('admin/' .$item->id .'/edit')}}" class="btn btn-primary btn-sm">
    ...
    <script>
      function showEdit(q){
        ...
        function delet(q){
          ...
          {{-- modal delete --}}
          <form action="{{ url('deleteAdmin', $item->id)}}" method="POST" class="modal fade" tabindex="-1" role="dialog" id="modal-hapus-<?=$item->id?>" aria-modal="true"> 
            @method('delete')
            @csrf     
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">         
              ...
              <div class="modal-body">          
                 ...
                 <div class="modal-footer">           
                   ...
                   <a href="{{ url('deleteAdmin', $item->id)}}" class="btn btn-danger">Delete</a>
